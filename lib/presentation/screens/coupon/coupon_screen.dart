            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return CouponListWidget(
                    coupon: coupon,
                    currentSecondaryThemeColor: currentSecondaryThemeColor,
                ...
                child: BlocListener<CouponBloc, CouponState>(
                  listener: (context, state) {
                    if (state is CouponLoading) {
                      ...
                      Navigator.pop(context);
                      _showCouponResult(context,
                          "El Cupon Ingresado Ya estaba claimeado o No Disponible");
                    }
                  },
                    ...
                    void validate() {
                      if (couponIdController.text.isEmpty) {
                        setState(() {
                          showError = true;
                          errorMessage =
                              'El Codigo del cupon no puede estar vacio.';
                          return;
                        });
                      }
                      ...
                      context
                          .read<CouponBloc>()
                          .add(ClaimCoupon(couponId: couponIdController.text));
                    }
      ...
      children: [
        ClipPath(
          clipper: TicketRoundedEdgeClipper(
              edge: Edge.horizontal, position: 45, radius: 30),
          child: Container(
