...
class CartItemMapper {
  ...
  factory CartItemMapper.fromJsonMap(Map<String, dynamic> json) =>
      CartItemMapper(
          id: json['id'],
          name: json['name'],
  ...
  factory CartItemMapper.fromIsarCartItem(IsarCartitem isarItem) =>
      CartItemMapper(
          id: isarItem.id,
          name: isarItem.name,
          imgUrl: isarItem.imgUrl,
          price: isarItem.price,
          presentation: 'presentation',
          quantity: isarItem.quantity,
          type: isarItem.type);
