...
class OrderDriverPositionBloc
    extends Bloc<DriverPositionOrderEvent, DriverPositionOrderState> {
  ...
  Future<void> _onLoadDriverPosition(LoadDriverPositionOrderEvent event,
      Emitter<DriverPositionOrderState> emit) async {
    emit(LoadDriverPositionOrderLoadingState());

    try {
      final driverPosition = await getDriverPositionOrderUseCase
          .execute(GetDriverPositionOrderUseCaseInput(id: event.id));
